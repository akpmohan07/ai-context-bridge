...
[`docs/key-engineering-decisions/`](docs/key-engineering-decisions/) for
write-ups of the harder problems this cycle solved.
...
### Fixed
- Sub-minute gaps in Time Awareness no longer render `0 min since last
  message`.
